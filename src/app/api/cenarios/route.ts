...
const DEFAULT_SCENARIOS = [
  {
    ...
    resultados: {
      ...
      lotacaoUAPorHa: 0.6,
      rendimentoCarcacaPct: 54,
      pesoCarcacaPorCabeca: 291.6,
      arrobasCarcacaPorCabeca: 19.44,
      custoPorKgCarcaca: 17.71,
      custoRendimentoPorCabeca: 13.15,
      impactoUmPontoRendimento: 57285,
      kgVivoPorArrobaCarcaca: 27.8,
      lucro: 513150,
      margemLiquida: 16.7,
      custoArroba: 265.62,
